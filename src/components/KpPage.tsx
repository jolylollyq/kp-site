                  ...
                  <div className="space-y-5">
                    <div className="flex gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-xs text-slate-400">Онлайн-запись и ответы на типовые вопросы экономят 3-5 часов работы администратора в день. При среднем окладе администратора 50 000 ₽/мес это высвобождает ~30 000–45 000 ₽ в месяц, которые вы уже платите, но можете перенаправить на другие задачи</p>
                      </div>
                    </div>
                    <div className="flex gap-3">
                      <div className="w-2 h-2 rounded-full bg-[#6366f1] shrink-0 mt-2.5" />
